...
Currently not being supported- there's something weird going on between jquery and the javascript that's highly 
dependant on the version of jquery you're using. I don't really have time to figure it out right now, but I'll 
keep this up in case anyone wants to poke at it.
